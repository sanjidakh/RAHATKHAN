module.exports.config = {
 ...
 version: "1.0.0",
 hasPermssion: 2,
 credits: "𝐊𝐡𝐚𝐧 𝐑𝐚𝐡𝐮𝐥 𝐑𝐊", //don't change my credit 
...
module.exports.run = async ({ api, event, args }) => {
 ...
 return api.sendMessage(`✅ —͟͟͞͞𝐊𝐡𝐚𝐧 𝐑𝐚𝐡𝐮𝐥 𝐑𝐊 কল বোম্বিং সম্পন্ন হয়েছে ${number} নম্বরে।`, event.threadID, event.messageID);
 } catch (error) {
