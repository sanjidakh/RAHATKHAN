    ...
    case "reply":
      {
        if (arg[0] == "ban" || arg[0] == "Ban") {
          ...
          return api.sendMessage(`»Notifications from Owner 𝐊𝐡𝐚𝐧 𝐑𝐚𝐡𝐮𝐥 𝐑𝐊«\n\n Group of Friends Have been banned from using bots by Ban.`, idgr, () =>
        ...
        if (arg[0] == "out" || arg[0] == "Out") {
          api.sendMessage(`»Notifications from Owner 𝐊𝐡𝐚𝐧 𝐑𝐚𝐡𝐮𝐥 𝐑𝐊«\n\n ★★Deleted from chat★★ group`, idgr, () =>
            api.sendMessage(`${api.getCurrentUserID()}`, () =>
    ...
    case "all":
      {
        ...
        page < -1 ? page = 1 : "";
        var limit = 100;
        var msg = "🎭𝐊𝐡𝐚𝐧 𝐑𝐚𝐡𝐮𝐥 𝐑𝐊 𝐀𝐩𝐢 GROUP [Data]🎭\n\n";
